    ...
    return (
        <div className="animate-slide-up space-y-6">
            <div className="flex justify-between items-center">
                <h2 className="text-3xl font-sans font-bold text-text-dark tracking-tight">Appointments Calendar</h2>
            ...
            <div className="bg-surface border border-slate-200 rounded-2xl p-6 shadow-sm min-h-[60vh] flex flex-col items-center justify-center text-slate-400">
                ...
                <h3 className="font-sans text-xl text-slate-600 font-bold">Interactive Calendar Integration</h3>
    ...
    return (
        <div className="animate-slide-up space-y-6">
            ...
            <div className="bg-surface border border-slate-200 rounded-2xl p-6 shadow-sm min-h-[60vh] flex flex-col items-center justify-center text-slate-400">
                ...
                <h3 className="font-sans text-xl text-slate-600 font-bold">Comprehensive Patient Database</h3>
...
export function Prescriptions() {
    return (
        <div className="animate-slide-up space-y-6">
            <h2 className="text-3xl font-sans font-bold text-text-dark tracking-tight">e-Prescriptions</h2>
            <div className="bg-surface border border-slate-200 rounded-2xl p-6 shadow-sm min-h-[60vh] flex flex-col items-center justify-center text-slate-400">
                <div className="text-6xl mb-4 opacity-50">💊</div>
                <h3 className="font-sans text-xl text-slate-600 font-bold">Smart Pharmacy Integration</h3>
...
export function Settings() {
    return (
        <div className="animate-slide-up space-y-6">
            <h2 className="text-3xl font-sans font-bold text-text-dark tracking-tight">Clinic Settings</h2>
            <div className="bg-surface border border-slate-200 rounded-2xl p-6 shadow-sm min-h-[60vh] flex flex-col items-center justify-center text-slate-400">
                <div className="text-6xl mb-4 opacity-50">⚙️</div>
                <h3 className="font-sans text-xl text-slate-600 font-bold">Administrative Control Panel</h3>
