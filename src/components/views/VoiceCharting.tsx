    ...
    return (
        <div className="flex items-center gap-2">
            <button
                ...
                className={`relative flex items-center gap-1.5 px-3 py-1.5 rounded-lg font-bold text-[10px] transition-all active:scale-95 disabled:opacity-50 ${isListening
