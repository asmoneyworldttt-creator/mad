                                ...
                                <tbody className="divide-y divide-slate-100">
                                    {transactions.length > 0 ? transactions.map((t, idx) => (
                                        <tr key={t.id} className="hover:bg-slate-50/80 transition-colors">
                                            ...
                                            <td className="p-4 text-sm text-right text-slate-600">Γé╣{t.rate?.toLocaleString()}</td>
                                            <td className="p-4 text-sm text-right font-bold text-primary">Γé╣{t.total?.toLocaleString()}</td>
                                        </tr>
                                    )) : (
                                ...
                                <tbody className="divide-y divide-slate-100">
                                    {orders.length > 0 ? orders.map((o) => (
                                        <tr key={o.id} className="hover:bg-slate-50/80 transition-colors">
                                            ...
                                            <td className="p-4 text-sm text-right font-bold text-text-dark">Γé╣{o.cost?.toLocaleString()}</td>
                                        </tr>
                                    )) : (
