            ...
            <motion.div className="flex flex-col items-end">
                {isMinimized && (
                    <motion.div
                        ...
                        className="mb-2 px-3 py-1.5 bg-white border border-slate-200 rounded-lg shadow-sm text-[10px] font-bold text-slate-500  flex items-center gap-2 cursor-pointer hover:bg-slate-50"
